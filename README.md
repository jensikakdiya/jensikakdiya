...
- 📚 **[Bookshop Management System](https://github.com/jensikakdiya/bookshop-management)**  
  Web-based application to manage book inventory, sales, and customer data using PHP and MySQL.

- 🌆 **[Smart City Management System](https://github.com/jensikakdiya/smart-city)**  
  Demonstrates smart infrastructure and service management using IoT concepts and web technologies.

- 🔐 **[File Encryption & Decryption Tool](https://github.com/jensikakdiya/file-encryption-and-decryption)**  
  Python and PHP-based application implementing AES encryption for secure file storage and transfer.

- ✋ **[Hand Gesture & Sign Language Recognition](https://github.com/jensikakdiya/Hand-signals-recognition-)**  
  Real-time computer vision system built using Python, OpenCV, MediaPipe, and Machine Learning to recognize hand gestures and sign language symbols via webcam.
